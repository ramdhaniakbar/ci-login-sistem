...
class Auth extends CI_Controller
{
   ...
   public function registration()
   {
      ...
      if ($this->form_validation->run() == FALSE) {
         $data['title'] = 'CodeIgniter User Registration';
         $this->load->view('templates/auth_header', $data);
   ...
   private function _sendEmail($token, $type)
   {
      $config = [
         ...
         'smtp_user' => 'ramdhaniakbarmuhamad@gmail.com',
         'smtp_pass' => 'ybojmmwytcolkhaw',
         'smtp_port' => 465,
         'mailtype' => 'html',
         'charset' => 'utf-8',
         'newline' => "\r\n"
      ...
      $this->email->from('ramdhaniakbarmuhamad@gmail.com', 'Muhamad Ramdhani Akbar');
